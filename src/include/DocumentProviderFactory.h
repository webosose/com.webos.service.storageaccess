...
class DocumentProviderFactory
{
    public:
        ...
        virtual  std::shared_ptr<DocumentProvider> create() const = 0;
        virtual const char* getName() const = 0;

        static std::shared_ptr<DocumentProvider> createDocumentProvider(const std::string& name);
        typedef std::shared_ptr<DocumentProviderFactory> Factory;
